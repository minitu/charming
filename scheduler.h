...
__device__ __forceinline__ Envelope* create_envelope(MsgType type, size_t msg_size) {
...
__device__ __forceinline__ void send_msg(Envelope* env, size_t msg_size, int dst_pe) {
...
__device__ __forceinline__ void send_term_msg(int dst_pe) {
...
__device__ __forceinline__ void send_reg_msg(int chare_id, int ep_id,
